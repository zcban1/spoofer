...
$NomiFileDiLog = @("farlight 84 epic log - File e Cartelle.txt")
...
# Lista dei nomi dei file da cercare
$fileNames = @("farlight 84 epic log - Elementi di Registro.txt") # Aggiungi altri nomi di file secondo necessità
